 ...
 * </p>
 * <ul>
 *   <li>{@link de.hu_berlin.ensureII.sre.model.sre.impl.ChoiceImpl#getSubnodes <em>Subnodes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ChoiceImpl extends NodeImpl implements Choice {
    ...
    protected EClass eStaticClass() {
        return SrePackage.Literals.CHOICE;
    }
    ...
    public EList<Node> getSubnodes() {
        if (subnodes == null) {
            subnodes = new EObjectContainmentEList<Node>(Node.class, this, SrePackage.CHOICE__SUBNODES);
        }
        return subnodes;
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case SrePackage.CHOICE__SUBNODES:
