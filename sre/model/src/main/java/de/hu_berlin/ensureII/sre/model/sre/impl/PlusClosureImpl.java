...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Plus Closure</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.hu_berlin.ensureII.sre.model.sre.impl.PlusClosureImpl#getLoopProbability <em>Loop Probability</em>}</li>
 *   <li>{@link de.hu_berlin.ensureII.sre.model.sre.impl.PlusClosureImpl#getToLoop <em>To Loop</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PlusClosureImpl extends NodeImpl implements PlusClosure {
    /**
    ...
    protected EClass eStaticClass() {
        return SrePackage.Literals.PLUS_CLOSURE;
    }
    ...
    public void setLoopProbability(double newLoopProbability) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SrePackage.PLUS_CLOSURE__LOOP_PROBABILITY, oldLoopProbability, loopProbability));
    }
    ...
    public NotificationChain basicSetToLoop(Node newToLoop, NotificationChain msgs) {
        ...
        toLoop = newToLoop;
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SrePackage.PLUS_CLOSURE__TO_LOOP, oldToLoop, newToLoop);
    ...
    public void setToLoop(Node newToLoop) {
        if (newToLoop != toLoop) {
            ...
            if (toLoop != null)
                msgs = ((InternalEObject)toLoop).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SrePackage.PLUS_CLOSURE__TO_LOOP, null, msgs);
            if (newToLoop != null)
                msgs = ((InternalEObject)newToLoop).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SrePackage.PLUS_CLOSURE__TO_LOOP, null, msgs);
            msgs = basicSetToLoop(newToLoop, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, SrePackage.PLUS_CLOSURE__TO_LOOP, newToLoop, newToLoop));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case SrePackage.PLUS_CLOSURE__TO_LOOP:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case SrePackage.PLUS_CLOSURE__LOOP_PROBABILITY:
