 ...
 * @generated
 */
public class TransitiongraphPackageImpl extends EPackageImpl implements TransitiongraphPackage {
    /**
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    private EClass transitionGraphEClass = null;
     ...
     * @see transitiongraph.TransitiongraphPackage#eNS_URI
     * @see #init()
     * @generated
     */
    private TransitiongraphPackageImpl() {
        super(eNS_URI, TransitiongraphFactory.eINSTANCE);
    }
     ...
     * 
     * <p>This method is used to initialize {@link TransitiongraphPackage#eINSTANCE} when that field is accessed.
     ...
     * @generated
     */
    public static TransitiongraphPackage init() {
        if (isInited) return (TransitiongraphPackage)EPackage.Registry.INSTANCE.getEPackage(TransitiongraphPackage.eNS_URI);

        // Obtain or create and register package
        TransitiongraphPackageImpl theTransitiongraphPackage = (TransitiongraphPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof TransitiongraphPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new TransitiongraphPackageImpl());

        isInited = true;

        // Create package meta-data objects
        theTransitiongraphPackage.createPackageContents();

        // Initialize created meta-data
        theTransitiongraphPackage.initializePackageContents();

        // Mark meta-data to indicate it can't be changed
        theTransitiongraphPackage.freeze();

  
        // Update the registry and return the package
        EPackage.Registry.INSTANCE.put(TransitiongraphPackage.eNS_URI, theTransitiongraphPackage);
        return theTransitiongraphPackage;
    }
     ...
     * @generated
     */
    public EClass getTransitionGraph() {
        return transitionGraphEClass;
    }
     ...
     * @generated
     */
    public EReference getTransitionGraph_States() {
        return (EReference)transitionGraphEClass.getEStructuralFeatures().get(0);
    }
     ...
     * @generated
     */
    public EReference getTransitionGraph_Transitions() {
        return (EReference)transitionGraphEClass.getEStructuralFeatures().get(1);
    }
     ...
     * @generated
     */
    public TransitiongraphFactory getTransitiongraphFactory() {
        return (TransitiongraphFactory)getEFactoryInstance();
    }
    ...
    public void createPackageContents() {
        ...
        transitionGraphEClass = createEClass(TRANSITION_GRAPH);
        createEReference(transitionGraphEClass, TRANSITION_GRAPH__STATES);
        createEReference(transitionGraphEClass, TRANSITION_GRAPH__TRANSITIONS);
    ...
    public void initializePackageContents() {
        ...
        initEClass(transitionGraphEClass, TransitionGraph.class, "TransitionGraph", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getTransitionGraph_States(), this.getState(), null, "states", null, 0, -1, TransitionGraph.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        initEReference(getTransitionGraph_Transitions(), this.getTransition(), null, "transitions", null, 0, -1, TransitionGraph.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
