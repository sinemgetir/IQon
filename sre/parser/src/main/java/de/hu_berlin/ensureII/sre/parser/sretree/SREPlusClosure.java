...
public class SREPlusClosure  extends SRETreeNode {
...
*****************************************************************************/
	 ...
	 */
	public SREPlusClosure(SRETreeNode sre, double rate) {
...
*****************************************************************************/
    ...
    public void setChildren(List<SRETreeNode> children){
        ...
        if(children.size() > 1) throw new IllegalArgumentException("PlusClosure can only have one child");
        /****************************************************************************/
    ...
    public void setChild(int index, SRETreeNode node) {
        ...
        if(index != 0) throw new IllegalArgumentException("index != 0 : PlusClosure has only 1 child");
        /****************************************************************************/
	...
	public void removeChild(int index) {
	    ...
	    SRETreeNode toRemove = getChildren().get(index);
